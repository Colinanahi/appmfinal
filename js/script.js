...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/reloj.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "",
                html: `Creado por <a href="//parzibyte.me/blog"></a>
        ...
        indicarFracaso() {
            Swal.fire({
                ...
                <p class="h4">Reinicia el juego</p>`,
